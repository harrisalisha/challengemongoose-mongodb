...
const mongoURI= "mongodb://harris:$ukoreno1@ds145093.mlab.com:45093/ffcproject";
...
var createAndSavePerson = function(done) {
    var person = new Person ({name: 'jonny', age: 34, favoriteFoods: ['tiramisu','cake']});
...
var queryChain = function(done) {
  ...
  Person.find({favoriteFoods: foodToSeach}).sort("asc").limit(2).select({age: 0}).exec(function(err, data){
    err ? done(err) : done(null, data);
  });
  //done(null/*, data*/);
};
